# Mini-Projeto 1 - Análise Exploratória de Dados Sócio-Econômicos
...
# Carrega o dataset
dados <- read.csv("/Users/scyc92/Desktop/Curso/DSA/BigDataAnalyticsR/Projeto 1 - Analise Exploratoria/dataset.csv")
